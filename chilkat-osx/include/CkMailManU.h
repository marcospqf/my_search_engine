...
class CK_VISIBLE_PUBLIC CkMailManU  : public CkClassWithCallbacksU
{
	...
	// 
	bool SshAuthenticatePk(const uint16_t *bSmtp, CkSshKeyU &sshUsername);

	// Creates an asynchronous task to call the SshAuthenticatePk method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SshAuthenticatePkAsync(const uint16_t *bSmtp, CkSshKeyU &sshUsername);
	...
	// LastErrorText property to support@chilkatsoft.com.
	// 
	bool SshAuthenticatePw(const uint16_t *bSmtp, const uint16_t *sshLogin);

	// Creates an asynchronous task to call the SshAuthenticatePw method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskU *SshAuthenticatePwAsync(const uint16_t *bSmtp, const uint16_t *sshLogin);
